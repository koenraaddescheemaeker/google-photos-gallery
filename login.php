<?php
/**
 * FORCEKES - login.php (Nuclear Reset Edition)
 */
...
$params = [
    ...
    'access_type'            => 'offline',
    'prompt'                 => 'consent select_account', // Dwingt het vinkjes-scherm af
...
<head>
    <meta charset="UTF-8">
    <title>Forcekes | Auth Reset</title>
...
<body class="text-white flex items-center justify-center min-h-screen">
    <div class="max-w-md w-full bg-zinc-900 border border-zinc-800 p-12 rounded-[3rem] shadow-2xl text-center">
        <h1 class="text-3xl font-black italic uppercase text-blue-500 mb-6 italic">Geforceerde <span class="text-white">Reset</span></h1>
        <p class="text-zinc-500 text-xs mb-10 leading-relaxed italic">
            De vorige tokens waren "besmet". Klik hieronder, log in, en <strong>VINK HET VAKJE VOOR FOTO'S AAN</strong>.
        </p>
