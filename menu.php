<nav class="fixed top-0 left-0 right-0 z-[5000] bg-black/60 backdrop-blur-xl border-b border-white/5">
    <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <a href="index.php" class="flex items-center space-x-3 group">
            <span class="text-white font-black italic uppercase tracking-tighter text-xl">FORCEKES<span class="text-blue-600">PORTAAL</span></span>
        </a>
        ...
        <div class="hidden md:flex items-center space-x-8">
            ...
            <a href="zwaaikamer.php" class="p-2 bg-zinc-900 rounded-full hover:bg-blue-600 transition relative" title="Zwaaikamer">
            ...
            <a href="auth-handler.php?action=logout" class="text-[10px] font-black uppercase tracking-[0.2em] text-red-900 hover:text-red-500 transition">Logout</a>
        </div>
    </div>
</nav>